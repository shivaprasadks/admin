                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    ...
                                    <button style="float: right;" type="button" class="btn small btn-success fa fa-edit" onclick="vendorEdit(<?php echo $guest_list[1]['VNID'] ?>)"></button>
                                </h3>
                            </div>
    ...
    <!-- /#wrapper -->
      <script type="text/javascript">
        function vendorEdit($vid){
           ...
           console.log($vid); 
           window.open("vendor_edit.php?vid="+$vid,"_self")
