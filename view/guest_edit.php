                            ...
                            <form action="guest_add.php" method="POST">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        ...
                                        <i class="fa fa-info-circle" aria-hidden="true"></i>Edit Guest Details #<?php echo $guest_list[1]['GID'] ?> 
                                    </h3>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-1">
                                         ...
                                         <div class="col-md-4">
                                          <textarea rows="4" cols="50" type="text" name="MESSAGE" required ><?php echo $guest_list[1]['MESSAGE'] ?></textarea>
                                        </div>
                                         <input type="hidden" name="GID" value="<?php echo $guest_list[1]['GID'] ?>" required >
                                    </div>  
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                     ...
                                     <div class="col-md-4">
                                      <textarea rows="4" cols="50" type="text" name="MESSAGE" placeholder="Message" required ></textarea>
                                    </div>
                                      <input type="hidden" name="GID" value="0" required >
                                </div>  
                                <div class="col-md-1 col-md-offset-8">
