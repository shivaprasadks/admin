                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                     ...
                                     <div class="col-md-4">
                                        <h4> <?php echo $guest_list[1]['EMAIL'] ?> </h4>
                                        <button type="button" class="btn small btn-primary fa fa-paper-plane" onclick="sendMyMail('<?php echo $guest_list[1]['EMAIL'] ?>','<?php echo $guest_list[1]['NAME'] ?>')" ></button>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-1">
