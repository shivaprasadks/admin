        ...
        <?php include('header_view.php'); 
         ...
         if($_GET['vid'] != 0){
            ...
            $vid = $_GET['vid'];
             ...
             $guest_list[] = array();
            $sql = "SELECT * FROM wpt_vendor WHERE VNID = $vid";
                        ...
                        <form action="vendor_add.php" method="POST">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    ...
                                    <i class="fa fa-info-circle" aria-hidden="true"></i> Vendors Details #<?php echo $guest_list[1]['VNID'] ?> 
                                </h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                     ...
                                     <input type="hidden" name="VNID" value="<?php echo $guest_list[1]['VNID'] ?>" required >
                                </div>  
                        ...
                        <form action="vendor_add.php" method="POST">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    ...
                                    <i class="fa fa-info-circle" aria-hidden="true"></i> Add Vendor Details 
                                </h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                     ...
                                     <div class="col-md-4">
                                      ...
                                      <input type="hidden" name="VNID" value="0" required >
                                </div>  
                                <div class="col-md-1 col-md-offset-8">
